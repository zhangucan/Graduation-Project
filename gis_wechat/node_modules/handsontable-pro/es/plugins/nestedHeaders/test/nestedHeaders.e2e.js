describe('NestedHeaders', function () {
  ...
  describe('Selection:', function () {
    it('should select every column under the extended header', function () {
      ...
      expect(this.$container.find('.ht_clone_top thead tr:eq(0) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', '', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(1) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', '', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', '', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(2) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'hiddenHeader', '', 'hiddenHeader', '', 'hiddenHeader', '', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(3) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', '', '', '', '', '', '', '']);
      ...
      expect(this.$container.find('.ht_clone_top thead tr:eq(0) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', '', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(1) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', '', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(2) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'hiddenHeader', 'ht__highlight ht__active_highlight', 'hiddenHeader', '', 'hiddenHeader', '', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(3) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', '', '', '', '', '']);
      ...
      expect(this.$container.find('.ht_clone_top thead tr:eq(0) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', 'hiddenHeader ht__highlight ht__active_highlight', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(1) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', 'ht__highlight ht__active_highlight', 'hiddenHeader', 'hiddenHeader', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(2) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'hiddenHeader', 'ht__highlight ht__active_highlight', 'hiddenHeader', 'ht__highlight ht__active_highlight', 'hiddenHeader', 'ht__highlight ht__active_highlight', 'hiddenHeader', '']);
      expect(this.$container.find('.ht_clone_top thead tr:eq(3) th').map(function (_, el) {
        return $(el).attr('class');
      }).toArray()).toEqual(['', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', 'ht__highlight ht__active_highlight', '']);
    ...
    it('should add selection borders in the expected positions, when selecting multi-columned headers', function () {
      ...
      var $headerLvl3 = this.$container.find('.ht_clone_top thead tr:eq(2) th:eq(1)');
      var $firstRow = this.$container.find('.ht_master tbody tr:eq(0)');
      var $lastRow = this.$container.find('.ht_master tbody tr:eq(3)');
      var $tbody = this.$container.find('.ht_master tbody');

      var $topBorder = this.$container.find('.wtBorder.area').eq(0);
      var $bottomBorder = this.$container.find('.wtBorder.area').eq(2);
      var $leftBorder = this.$container.find('.wtBorder.area').eq(1);
      var $rightBorder = this.$container.find('.wtBorder.area').eq(3);
