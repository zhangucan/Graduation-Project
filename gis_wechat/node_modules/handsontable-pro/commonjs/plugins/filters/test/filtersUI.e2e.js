...
describe('Filters UI', function () {
  ...
  describe('Dimensions of filter\'s elements inside drop-down menu', function () {
    ...
    it('should fit the single value to the value box element (pixel perfect)', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        colHeaders: true,
    ...
    it('should display proper width of value box after change of another elements width to lower ' + '(bug: once rendered `MultipleSelectUI` has elbowed the table created by AutoColumnSize plugin)', _asyncToGenerator(function* () {
      var hot = handsontable({
        colHeaders: true,
        dropdownMenu: {
          items: {
    ...
    it('should display proper width of the menu after second render (bug: effect of resizing menu by the 3px) - ' + 'AutoColumnSize counts also border added to drop-down menu', _asyncToGenerator(function* () {
      handsontable({
        colHeaders: true,
        dropdownMenu: true,
        filters: true
    ...
    it('should display proper width of conditional select', _asyncToGenerator(function* () {
      var hot = handsontable({
        colHeaders: true,
        dropdownMenu: true,
        filters: true,
    ...
    it('should not expand the drop-down menu after selecting longer value inside the conditional select', _asyncToGenerator(function* () {
      handsontable({
        colHeaders: true,
        dropdownMenu: true,
        filters: true,
